      ...
      >
        <section className='flex flex-col justify-center gap-2 xs:items-center xl:items-stretch'>
          <h1 className='hidden xs:flex'>
            <Link href='/home'>
              <a
                className='custom-button main-tab text-accent-indigo transition hover:bg-light-primary/10 
                           focus-visible:bg-accent-indigo/10 focus-visible:!ring-accent-indigo/80
          ...
          >
            ...
            />
            <p className='hidden xl:block'>Wave</p>
          </Button>
        </section>
