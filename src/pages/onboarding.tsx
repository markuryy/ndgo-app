        ...
        <div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 relative z-10'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12'>
            ...
            <div className='border border-white rounded-lg p-6'>
              ...
              <p className='text-base'>On ndgo, posts are called &ldquo;waves,&rdquo; just like how everything in the universe, from light to sound to wifi, is made up of waves. We believe in the power of these waves to carry your ideas and emotions.</p>
            </div>
            <div className='border border-white rounded-lg p-6'>
            ...
            <div className='border border-white rounded-lg p-6'>
              ...
              <p className='text-base'>ndgo is pronounced as &ldquo;indigo&rdquo; - a color that represents intuition, creativity, and deep understanding.</p>
            </div>
          </div>
          <div className='text-center'>
